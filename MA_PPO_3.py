...
def test_Fedppo(args=get_args()):
    ...
    for epoch in range(1, 1 + args.epoch):
        ...
        for i in range(num_of_block):
            ...
            FD_buffers[i].reset()
        # aggregate
        for global_param, local_param1, local_param2, local_param3 in zip(global_server_policy.actor.parameters(),
                                                                        server_policies[0].actor.parameters(),
                                                                        server_policies[1].actor.parameters(),
                                                                        server_policies[2].actor.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_server_policy.critic.parameters(),
                                                                        server_policies[0].critic.parameters(),
                                                                        server_policies[1].critic.parameters(),
                                                                        server_policies[2].critic.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_ND_policy.actor.parameters(),
                                                                        ND_policies[0].actor.parameters(),
                                                                        ND_policies[1].actor.parameters(),
                                                                        ND_policies[2].actor.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_ND_policy.critic.parameters(),
                                                                        ND_policies[0].critic.parameters(),
                                                                        ND_policies[1].critic.parameters(),
                                                                        ND_policies[2].critic.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_RD_policy.actor.parameters(),
                                                                        RD_policies[0].actor.parameters(),
                                                                        RD_policies[1].actor.parameters(),
                                                                        RD_policies[2].actor.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_RD_policy.critic.parameters(),
                                                                        RD_policies[0].critic.parameters(),
                                                                        RD_policies[1].critic.parameters(),
                                                                        RD_policies[2].critic.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_FD_policy.actor.parameters(),
                                                                        FD_policies[0].actor.parameters(),
                                                                        FD_policies[1].actor.parameters(),
                                                                        FD_policies[2].actor.parameters()):
            global_param.data.copy_((local_param1.data + local_param2.data + local_param3.data) / num_of_block)
        for global_param, local_param1, local_param2, local_param3 in zip(global_FD_policy.critic.parameters(),
